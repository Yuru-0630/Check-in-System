              ...
              <div class="col-md-6">
                <div class="card mx-4">
                  <div class="card-body p-4">
                    <form method="POST" action="../controller/add_class.php" enctype="multipart/form-data">
                      <center><h1>新增課程簽到表</h1></center>
                      <br/>
                      ...
                      <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" id="datetimepicker1" name="starting_time" placeholder="開始時間" >
                      </div>
                    ...
                    <button type="button" class="btn btn-block btn-default" onclick="location.href=\'attendance_page.php?i=1\'" style="margin-top: 8px;">取消</button>
                  </div>
                </div>
              </div>
            </div>
